...
from unstructure_my.tools.vision import vision_completion

load_dotenv()


def unstructure_pdf(pdf_name, extract_images=False, use_api=False):
    min_image_width = 250
    ...
    if use_api:
        elements = partition_via_api(
            ...
            api_url="https://beijinginformation-2zby8veb.api.unstructuredapp.io/general/v0/general"
        )
    else:
        elements = partition(
            filename=pdf_name,
